...
If you assembled it yourself, either through a kit or by sourcing the parts yourself, link:docs/troubleshooting-Kit.adoc[start here]

If you purchased a pre-assembled kit, or have already gone through the hardware troubleshooting steps, link:docs/troubleshooting-assembled.adoc[start here]
